...
dbsnp_version = "154"  # => https://ftp.ncbi.nih.gov/snp/redesign/archive/
genes_version = (
    "37"  # => https://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/latest_release/ 37 => 44
)
...
_single_filepaths: Dict[str, Callable[[], str]] = {
    ...
    "gencode":(lambda : get_generated_path("resources/gencode.v{}.annotation.bed.gz".format(44)
    )
    ),
    "topLociCond":(lambda : get_generated_path("resources/topLociCond.tsv.gz")),
    # simple:
